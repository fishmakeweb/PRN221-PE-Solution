...
public partial class AirConditionerShop2024DbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.AirConditionerId).HasName("PK__AirCondi__EE2EB7396F79D832");
        ...
        {
            entity.HasKey(e => e.MemberId).HasName("PK__StaffMem__0CF04B387EA82D6D");

            entity.ToTable("StaffMember");

            entity.HasIndex(e => e.EmailAddress, "UQ__StaffMem__49A14740EB71878C").IsUnique();
        ...
        {
            entity.HasKey(e => e.SupplierId).HasName("PK__Supplier__4BE666B4CD8ED1CC");
